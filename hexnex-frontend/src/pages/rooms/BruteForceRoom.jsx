      ...
      switch (step) {
        ...
        case 1:
          if (inputs.portalPass === 'password') {
            ...
            message.error('Wrong password! Did you look at the portal source?');
          }
          break;
        case 2:
          if (inputs.sshPass === 'vault123') {
            ...
            message.error('Wrong SSH password! Check SSH page source.');
          }
          break;
        case 3:
          if (inputs.hiddenPass === 'h1dden') {
            ...
            message.error('Wrong! Inspect hidden admin page source.');
          }
          break;
        case 4:
          if (inputs.finalPass === 'finalpayload') {
            ...
            message.error('Wrong password! Check encrypted file page source.');
          }
          break;
        default:
          break;
        ...
        <Card style={{ background: '#112d4e', borderRadius: '12px' }}>
          ...
          {step === 0 && !loading && (
            <>
              ...
              <Paragraph style={{ color: '#dbe2ef' }}>
                Find the correct vault username hidden in legacy page.
              </Paragraph>
              <Input 
              ...
              <Paragraph>
                🔍 <a href="/vault-login" target="_blank">Visit vault login page & view source</a>
              </Paragraph>
          ...
          {step === 1 && !loading && (
            <>
              ...
              <Paragraph style={{ color: '#dbe2ef' }}>
                Password is hidden in portal page source.
              </Paragraph>
              <Input.Password
              ...
              <Paragraph>
                🔍 <a href="/portal" target="_blank">Visit portal & view source</a>
              </Paragraph>
              <Text style={{ color: '#dbe2ef' }}>Attempts: {attempts}</Text>
            </>
          )}
          ...
          {step === 2 && !loading && (
            <>
              ...
              <Paragraph style={{ color: '#dbe2ef' }}>
                Weak SSH password is hidden in SSH page source.
              </Paragraph>
              <Input.Password
              ...
              <Paragraph>
                🔍 <a href="/ssh-info" target="_blank">View SSH info page & source</a>
              </Paragraph>
              <Text style={{ color: '#dbe2ef' }}>Attempts: {attempts}</Text>
            </>
          )}
          ...
          {step === 3 && !loading && (
            <>
              ...
              <Paragraph style={{ color: '#dbe2ef' }}>
                Find hidden password in admin page source.
              </Paragraph>
              <Input.Password
              ...
              <Paragraph>
                🔍 <a href="/hidden-admin" target="_blank">Visit hidden admin page & view source</a>
              </Paragraph>
              <Text style={{ color: '#dbe2ef' }}>Attempts: {attempts}</Text>
            </>
          )}
          ...
          {step === 4 && !flagVisible && !loading && (
            <>
              ...
              <Paragraph style={{ color: '#dbe2ef' }}>
                Find the final password in encrypted file page source.
              </Paragraph>
              <Input.Password
              ...
              <Paragraph>
                🔍 <a href="/encrypted-file" target="_blank">View encrypted file page & source</a>
              </Paragraph>
              <Text style={{ color: '#dbe2ef' }}>Attempts: {attempts}</Text>
            </>
          )}
